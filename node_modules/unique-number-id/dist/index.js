 ...
 * @return number
 */
function uniqueNumberId(option) {
    const deviceId = (option === null || option === void 0 ? void 0 : option.deviceId) || getRandomNumber();
    if (deviceId > 99) {
...
function generateUniqueNumber(timestamp, deviceId, incrementedValue) {
    return Number(timestamp.toString() + "" + deviceId.toString() + "" + incrementedValue.toString());
}
function getRandomNumber() {
    return Math.floor(Math.random() * 9);
}
function getIncrementedValue(timestamp) {
